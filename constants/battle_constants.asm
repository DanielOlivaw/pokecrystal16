...
; BattleVarPairs indexes (see home/battle.asm)
	...
	const BATTLE_VARS_SUBSTATUS6 ; New
	const BATTLE_VARS_SUBSTATUS7 ; New
	...
	const BATTLE_VARS_SUBSTATUS6_OPP ; New
	const BATTLE_VARS_SUBSTATUS7_OPP ; New
...
; BattleVarLocations indexes (see home/battle.asm)
	...
	const PLAYER_SUBSTATUS_6 ; New
	const ENEMY_SUBSTATUS_6 ; New
	const PLAYER_SUBSTATUS_7 ; New
	const ENEMY_SUBSTATUS_7 ; New
	const PLAYER_STATUS
	const ENEMY_STATUS
...
; wPlayerSubStatus5 or wEnemySubStatus5 bit flags
	...
	enum SUBSTATUS_INGRAINED
	enum SUBSTATUS_AQUA_RING
	enum SUBSTATUS_TOXIC

; wPlayerSubStatus6 or wEnemySubStatus6 bit flags
	enum_start 7, -1
	enum SUBSTATUS_CONFUSED
	enum SUBSTATUS_ELECTRIC_CHARGED
	enum SUBSTATUS_ATE_BERRY
	enum SUBSTATUS_LASER_FOCUS
	enum SUBSTATUS_FLINCHED
	enum SUBSTATUS_MAGNET_RISE
	enum SUBSTATUS_GRUDGE
	enum SUBSTATUS_DROWSY

; wPlayerSubStatus7 or wEnemySubStatus7 bit flags
	enum_start 7, -1
	enum SUBSTATUS_ME_FIRST
	enum SUBSTATUS_POWDERED
	enum SUBSTATUS_ELECTRIFIED
	enum SUBSTATUS_UNKNOWN_4
	enum SUBSTATUS_UNKNOWN_5
	enum SUBSTATUS_UNKNOWN_6
	enum SUBSTATUS_UNKNOWN_7
	enum SUBSTATUS_UNKNOWN_8
...
; wPlayerScreens or wEnemyScreens bit flags
	...
	enum SCREENS_AURORA_VEIL
	enum SCREENS_SPIKES
	enum SCREENS_TOXIC_SPIKES
	enum SCREENS_STEALTH_ROCK
	enum SCREENS_STICKY_WEB
...
; values in wBattleWeather
	...
	const WEATHER_FOG_END
	const WEATHER_STORM_END
