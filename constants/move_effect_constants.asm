; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_SHATTER_CLAW
	const EFFECT_SPEED_UP_HIT
	const EFFECT_BRIGHT_MOSS
	const EFFECT_SHIELD_BASH
