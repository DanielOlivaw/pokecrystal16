...
; New Kanto items
	...
	const EVENT_SEAFOAM_ISLAND_B3F_BIG_PEARL
...
; New legendary encounters
	...
	const EVENT_ROCK_SUMMIT_ZAPDOS
...
; ???
	...
	const EVENT_ROCK_TUNNEL_2F_HIDDEN_HP_UP
	const EVENT_ROCK_TUNNEL_2F_HIDDEN_STAR_PIECE
	const EVENT_ROCK_SUMMIT_HIDDEN_CARBOS
	...
	const EVENT_CERULEAN_CAVE_B1F_DUSK_STONE
	const EVENT_CERULEAN_CAVE_B1F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_B1F_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_B1F_COMET_SHARD
	const EVENT_CERULEAN_CAVE_B1F_TWISTEDSPOON
