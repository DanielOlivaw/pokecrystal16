...
; Marts indexes (see data/items/marts.asm)
	...
	const MART_STANDARD_DEX ;MART_CHERRYGROVE_DEX
	const MART_STANDARD_BADGE_1
	const MART_STANDARD_BADGE_3
	const MART_STANDARD_BADGE_5
	const MART_STANDARD_BADGE_7
