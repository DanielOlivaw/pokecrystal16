...
; TryObjectEvent arguments (see engine/overworld/events.asm)
	...
	const OBJECTTYPE_TMHMBALL ; OBJECTTYPE_3
	const OBJECTTYPE_4
	const OBJECTTYPE_5
	const OBJECTTYPE_6
...
; MoveTutor setval arguments
	const_def 1
	const MOVETUTOR_FRENZY_PLANT ; 1
	const MOVETUTOR_BLAST_BURN   ; 2
	const MOVETUTOR_HYDRO_CANNON ; 3
	const MOVETUTOR_DRACO_METEOR ; 4
	const MOVETUTOR_STEEL_BEAM   ; 5
