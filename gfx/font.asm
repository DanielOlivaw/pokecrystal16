...
; INCLUDE "gfx/footprint_pointers.asm"
; INCLUDE "gfx/footprints.asm"

; Footprints::
	; indirect_table 2, 1
	; indirect_entries CELEBI, Footprints1
	; indirect_entries DEOXYS, Footprints2
	; indirect_entries NUM_POKEMON, Footprints3
	; indirect_table_end

; INCLUDE "gfx/footprints_1.asm"
; INCLUDE "gfx/footprints_2.asm"
; INCLUDE "gfx/footprints_3.asm"
