...
MapGroup_Cinnabar:
	...
	map SeafoamIsland1F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamIslandB1F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslandB2F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslandB3F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslandB4F, TILESET_SEAFOAM_DEPTHS, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
