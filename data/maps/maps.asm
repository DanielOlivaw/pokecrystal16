...
MapGroup_Olivine:
	...
	map OlivineTimsHouse, TILESET_HOUSE, INDOOR, OLIVINE_CITY, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineHouseBeta, TILESET_HOUSE, INDOOR, OLIVINE_CITY, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivinePunishmentSpeechHouse, TILESET_HOUSE, INDOOR, OLIVINE_CITY, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineGoodRodHouse, TILESET_HOUSE, INDOOR, OLIVINE_CITY, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineCafe, TILESET_GAME_CORNER, INDOOR, OLIVINE_CITY, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineMart, TILESET_MART, INDOOR, OLIVINE_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map OlivineCity, TILESET_JOHTO, TOWN, OLIVINE_CITY, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

MapGroup_Mahogany:
	map MahoganyRedGyaradosSpeechHouse, TILESET_HOUSE, INDOOR, MAHOGANY_TOWN, MUSIC_FALLARBOR_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route44, TILESET_JOHTO, ROUTE, ROUTE_44, MUSIC_ROUTE_119, FALSE, PALETTE_AUTO, FISHGROUP_REMORAID
	map MahoganyTown, TILESET_JOHTO, TOWN, MAHOGANY_TOWN, MUSIC_FALLARBOR_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map RadioTower1F, TILESET_RADIO_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower2F, TILESET_RADIO_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower3F, TILESET_RADIO_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower4F, TILESET_RADIO_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower5F, TILESET_RADIO_TOWER, INDOOR, RADIO_TOWER, MUSIC_RADIO_TOWER | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map UnionCave1F, TILESET_CAVE, CAVE, UNION_CAVE, MUSIC_OREBURGH_GATE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map UnionCaveB1F, TILESET_CAVE, CAVE, UNION_CAVE, MUSIC_OREBURGH_GATE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map UnionCaveB2F, TILESET_CAVE, CAVE, UNION_CAVE, MUSIC_OREBURGH_GATE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SlowpokeWellB1F, TILESET_CAVE, CAVE, SLOWPOKE_WELL, MUSIC_OREBURGH_GATE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SlowpokeWellB2F, TILESET_CAVE, CAVE, SLOWPOKE_WELL, MUSIC_OREBURGH_GATE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map OlivineLighthouse1F, TILESET_LIGHTHOUSE, DUNGEON, LIGHTHOUSE, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse2F, TILESET_LIGHTHOUSE, DUNGEON, LIGHTHOUSE, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse3F, TILESET_LIGHTHOUSE, DUNGEON, LIGHTHOUSE, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse4F, TILESET_LIGHTHOUSE, DUNGEON, LIGHTHOUSE, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse5F, TILESET_LIGHTHOUSE, DUNGEON, LIGHTHOUSE, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse6F, TILESET_LIGHTHOUSE, DUNGEON, LIGHTHOUSE, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map IlexForest, TILESET_FOREST, CAVE, ILEX_FOREST, MUSIC_SANTALUNE_FOREST, FALSE, PALETTE_NITE, FISHGROUP_POND
	map GoldenrodUnderground, TILESET_GATE, DUNGEON, GOLDENROD_CITY, MUSIC_PETALBURG_WOODS, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodUndergroundSwitchRoomEntrances, TILESET_ELITE_FOUR_ROOM, DUNGEON, GOLDENROD_CITY, MUSIC_PETALBURG_WOODS, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodUndergroundWarehouse, TILESET_UNDERGROUND, DUNGEON, GOLDENROD_CITY, MUSIC_PETALBURG_WOODS, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map MountMortar1FOutside, TILESET_DARK_CAVE, CAVE, MT_MORTAR, MUSIC_MT_CHIMNEY, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MountMortar1FInside, TILESET_DARK_CAVE, CAVE, MT_MORTAR, MUSIC_MT_CHIMNEY, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MountMortar2FInside, TILESET_DARK_CAVE, CAVE, MT_MORTAR, MUSIC_MT_CHIMNEY, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MountMortarB1F, TILESET_DARK_CAVE, CAVE, MT_MORTAR, MUSIC_MT_CHIMNEY, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map WhirlIslandNW, TILESET_DARK_CAVE, CAVE, WHIRL_ISLANDS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandNE, TILESET_DARK_CAVE, CAVE, WHIRL_ISLANDS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandSW, TILESET_DARK_CAVE, CAVE, WHIRL_ISLANDS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandCave, TILESET_DARK_CAVE, CAVE, WHIRL_ISLANDS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandSE, TILESET_DARK_CAVE, CAVE, WHIRL_ISLANDS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandB1F, TILESET_DARK_CAVE, CAVE, WHIRL_ISLANDS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandB2F, TILESET_DARK_CAVE, CAVE, WHIRL_ISLANDS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandLugiaChamber, TILESET_DARK_CAVE, CAVE, WHIRL_ISLANDS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map SilverCaveRoom1, TILESET_DARK_CAVE, CAVE, SILVER_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map SilverCaveRoom2, TILESET_CAVE, CAVE, SILVER_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SilverCaveRoom3, TILESET_CAVE, CAVE, SILVER_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map SilverCaveItemRooms, TILESET_CAVE, CAVE, SILVER_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map DarkCaveVioletEntrance, TILESET_DARK_CAVE, CAVE, DARK_CAVE, MUSIC_SCARY_HOUSE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map DarkCaveBlackthornEntrance, TILESET_DARK_CAVE, CAVE, DARK_CAVE, MUSIC_SCARY_HOUSE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map DragonsDen1F, TILESET_CAVE, CAVE, DRAGONS_DEN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map DragonsDenB1F, TILESET_JOHTO, CAVE, DRAGONS_DEN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map DragonShrine, TILESET_LAB, INDOOR, DRAGONS_DEN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TohjoFalls, TILESET_CAVE, CAVE, TOHJO_FALLS, MUSIC_METEOR_FALLS, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map DiglettsCave, TILESET_CAVE, CAVE, DIGLETTS_CAVE, MUSIC_PETALBURG_WOODS, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MountMoon, TILESET_CAVE, CAVE, MT_MOON, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UndergroundPath, TILESET_UNDERGROUND, GATE, UNDERGROUND_PATH, MUSIC_PETALBURG_WOODS, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, FUCHSIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianForest, TILESET_FOREST, ROUTE, VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_POND
	map RockTunnel2F, TILESET_DARK_CAVE, CAVE, ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map CeruleanCave1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
...
MapGroup_Ecruteak:
	...
	map EcruteakMart, TILESET_MART, INDOOR, ECRUTEAK_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map BlackthornDragonSpeechHouse, TILESET_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_BLACK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BlackthornEmysHouse, TILESET_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_BLACK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BlackthornMart, TILESET_MART, INDOOR, BLACKTHORN_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MoveDeletersHouse, TILESET_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_BLACK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route45, TILESET_JOHTO, ROUTE, ROUTE_45, MUSIC_JOHTO_SAFARI_GATE, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route46, TILESET_JOHTO, ROUTE, ROUTE_46, MUSIC_JOHTO_SAFARI_GATE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BlackthornCity, TILESET_JOHTO, TOWN, BLACKTHORN_CITY, MUSIC_BLACK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Cinnabar:
	...
	map SeafoamGym, TILESET_CAVE, INDOOR, SEAFOAM_ISLANDS, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_WHIRL_ISLANDS
	...
	map CinnabarIsland, TILESET_KANTO, TOWN, CINNABAR_ISLAND, MUSIC_FALLARBOR_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SeafoamIsland1F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_MARINE_TUBE, TRUE, PALETTE_DAY, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandB1F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MARINE_TUBE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandB2F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MARINE_TUBE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandB3F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MARINE_TUBE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandB4F, TILESET_SEAFOAM_DEPTHS, CAVE, SEAFOAM_ISLANDS, MUSIC_MARINE_TUBE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS

MapGroup_Cerulean:
	map CeruleanGymBadgeSpeechHouse, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_UNOVA_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_UNOVA_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeSpeechHouse, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_UNOVA_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanMart, TILESET_MART, INDOOR, CERULEAN_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanCity, TILESET_KANTO, TOWN, CERULEAN_CITY, MUSIC_UNOVA_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map RockSummit, TILESET_KANTO, ROUTE, ROCK_TUNNEL, MUSIC_NONE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Azalea:
	...
	map AzaleaMart, TILESET_MART, INDOOR, AZALEA_TOWN, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route33, TILESET_JOHTO_MODERN, ROUTE, ROUTE_33, MUSIC_ROUTE_205, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Violet:
	map Route32, TILESET_JOHTO, ROUTE, ROUTE_32, MUSIC_ROUTE_205, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	...
	map VioletMart, TILESET_MART, INDOOR, VIOLET_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route32RuinsOfAlphGate, TILESET_GATE, GATE, ROUTE_32, MUSIC_ROUTE_205, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStore1F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore2F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore3F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore4F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore5F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore6F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreElevator, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreRoof, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	map Route6, TILESET_KANTO, ROUTE, ROUTE_6, MUSIC_UNOVA_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route11, TILESET_KANTO, ROUTE, ROUTE_11, MUSIC_UNOVA_ROUTE_4, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map VermilionMart, TILESET_MART, INDOOR, VERMILION_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route6SaffronGate, TILESET_GATE, GATE, ROUTE_6, MUSIC_UNOVA_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6UndergroundPathEntrance, TILESET_GATE, GATE, ROUTE_6, MUSIC_UNOVA_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterCity, TILESET_KANTO, TOWN, PEWTER_CITY, MUSIC_FORTREE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PewterNidoranSpeechHouse, TILESET_HOUSE, INDOOR, PEWTER_CITY, MUSIC_FORTREE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterGym, TILESET_TOWER, INDOOR, PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMart, TILESET_MART, INDOOR, PEWTER_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterPokecenter1F, TILESET_POKECENTER, INDOOR, PEWTER_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterPokecenter2FBeta, TILESET_POKECENTER, INDOOR, PEWTER_CITY, MUSIC_FORTREE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterSnoozeSpeechHouse, TILESET_HOUSE, INDOOR, PEWTER_CITY, MUSIC_FORTREE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_FastShip:
	map OlivinePort, TILESET_PORT, ROUTE, OLIVINE_CITY, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map OlivinePortPassage, TILESET_UNDERGROUND, INDOOR, OLIVINE_CITY, MUSIC_SLATEPORT_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map Route18, TILESET_KANTO, ROUTE, ROUTE_18, MUSIC_HOENN_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FuchsiaCity, TILESET_KANTO, TOWN, FUCHSIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	map FuchsiaMart, TILESET_MART, INDOOR, FUCHSIA_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneMainOffice, TILESET_GAME_CORNER, INDOOR, FUCHSIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGym, TILESET_LAB, INDOOR, FUCHSIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsBrothersHouse, TILESET_HOUSE, INDOOR, FUCHSIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter1F, TILESET_POKECENTER, INDOOR, FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter2FBeta, TILESET_POKECENTER, INDOOR, FUCHSIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWardensHome, TILESET_HOUSE, INDOOR, FUCHSIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route15FuchsiaGate, TILESET_GATE, GATE, ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Lavender:
	map Route8, TILESET_KANTO, ROUTE, ROUTE_8, MUSIC_UNOVA_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route12, TILESET_KANTO, ROUTE, ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH_NO_SWARM
	map Route10South, TILESET_KANTO, ROUTE, ROUTE_10, MUSIC_CONTEST_LOBBY, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	...
	map LavenderMart, TILESET_MART, INDOOR, LAVENDER_TOWN, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route8SaffronGate, TILESET_GATE, GATE, ROUTE_8, MUSIC_UNOVA_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route12SuperRodHouse, TILESET_HOUSE, INDOOR, ROUTE_12, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Silver:
	map Route28, TILESET_KANTO, ROUTE, ROUTE_28, MUSIC_UNOVA_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SilverCaveOutside, TILESET_KANTO, TOWN, SILVER_CAVE, MUSIC_UNOVA_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Celadon:
	map Route7, TILESET_KANTO, ROUTE, ROUTE_7, MUSIC_UNOVA_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route16, TILESET_KANTO, ROUTE, ROUTE_16, MUSIC_HOENN_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route17, TILESET_KANTO, ROUTE, ROUTE_17, MUSIC_HOENN_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CeladonCity, TILESET_KANTO, TOWN, CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CeladonDeptStore1F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStoreElevator, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_HOENN_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonMansionRoof, TILESET_MANSION, TOWN, CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map CeladonGameCornerPrizeRoom, TILESET_GAME_CORNER, INDOOR, CELADON_CITY, MUSIC_GAME_CORNER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route16Gate, TILESET_GATE, GATE, ROUTE_16, MUSIC_HOENN_BICYCLE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7SaffronGate, TILESET_GATE, GATE, ROUTE_7, MUSIC_UNOVA_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route17Route18Gate, TILESET_GATE, GATE, ROUTE_17, MUSIC_HOENN_BICYCLE, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Cianwood:
	map Route40, TILESET_JOHTO, ROUTE, ROUTE_40, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route41, TILESET_JOHTO, ROUTE, ROUTE_41, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CianwoodCity, TILESET_JOHTO, TOWN, CIANWOOD_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ManiasHouse, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CianwoodPharmacy, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CianwoodPhotoStudio, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CianwoodLugiaSpeechHouse, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokeSeersHouse, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	map Route2, TILESET_KANTO, ROUTE, ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map TrainerHouse1F, TILESET_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrainerHouseB1F, TILESET_FACILITY, INDOOR, VIRIDIAN_CITY, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianMart, TILESET_MART, INDOOR, VIRIDIAN_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route2Gate, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VictoryRoadGate, TILESET_GATE, GATE, ROUTE_26, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestGateNorth, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestGateSouth, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	map Route5, TILESET_KANTO, ROUTE, ROUTE_5, MUSIC_UNOVA_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SaffronCity, TILESET_KANTO, TOWN, SAFFRON_CITY, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FightingDojo, TILESET_TRAIN_STATION, INDOOR, SAFFRON_CITY, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronGym, TILESET_UNDERGROUND, INDOOR, SAFFRON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMart, TILESET_MART, INDOOR, SAFFRON_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPokecenter1F, TILESET_POKECENTER, INDOOR, SAFFRON_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPokecenter2FBeta, TILESET_POKECENTER, INDOOR, SAFFRON_CITY, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrPsychicsHouse, TILESET_HOUSE, INDOOR, SAFFRON_CITY, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMagnetTrainStation, TILESET_TRAIN_STATION, INDOOR, SAFFRON_CITY, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo1F, TILESET_FACILITY, INDOOR, SAFFRON_CITY, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CopycatsHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, SAFFRON_CITY, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CopycatsHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, SAFFRON_CITY, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5UndergroundPathEntrance, TILESET_GATE, GATE, ROUTE_5, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5SaffronGate, TILESET_GATE, GATE, ROUTE_5, MUSIC_SOOTOPOLIS_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygroveMart, TILESET_MART, INDOOR, CHERRYGROVE_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
