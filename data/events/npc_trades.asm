...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_HAPPY,     KRABBY,     CIRCUB,     "VOLTY@@@@@@", $98, $88, PRZCUREBERRY, 29189, "TIM@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      DRAGONAIR,  FLOETTE,    "DORIS@@@@@@", $77, $66, SMOKE_BALL,   00283, "EMY@@@@@", TRADE_GENDER_FEMALE
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, MUDSDALE,   MAGNEZONE,  "MAGGIE@@@@@", $96, $66, METAL_COAT,   50082, "FOREST@@", TRADE_GENDER_EITHER
