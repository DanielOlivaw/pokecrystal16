...
; .ki_gi:    db SUNFLORA, CATERPIE, GYARADOS, RAPIDASH, NINETALES_A, GIRAFARIG, BELLOSSOM, KINGDRA, KINGLER, -1
; .ku_gu:    db GLOOM, PINECO, GLIGAR, KRABBY, GRANBULL, CROBAT, -1
; .ke_ge:    db ABRA, GENGAR, TAUROS, -1
; .ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, PSYDUCK, PHANPY, RATTATA_A, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
; .sa_za:    db RHYHORN, PUPITAR, CORSOLA_G, HITMONLEE, ZAPDOS_G, JOLTEON, SANDSHREW_A, SANDSLASH_A, -1 ; RHYDON should lead this list
...
; .na:       db ODDISH, EXEGGUTOR_A, -1
; .ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH_G, SNEASEL, POLIWHIRL, POLITOED, POLIWRATH, POLIWAG, -1
; .nu:       db QUAGSIRE, -1
; .ne:       db NATU, XATU, -1
; .no:       db DUNSPARCE, -1
; .ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME_G, TYROGUE, CLOYSTER, TYRANITAR, -1
...
; .fu_bu_pu: db MOLTRES_G, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTICUNO_G, JIGGLYPUFF, SNUBBULL, -1
...
; .ma:       db MAGCARGO, SLUGMA, QUILAVA, BELLSPROUT, WEEZING_G, MARILL, AZUMARILL, ELECTRODE, MANKEY, MANTINE, -1
...
; .ra:       db RAIKOU, RAICHU_A, CHANSEY, RATICATE_A, LAPRAS, VILEPLUME, LANTURN, -1
