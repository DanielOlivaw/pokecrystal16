	...
	; tm/hm learnset
	tmhm HEADBUTT, TOXIC, CURSE, HIDDEN_POWER, MUD_SHOT, HYPER_BEAM, PROTECT, RETURN, DIG, BRICK_BREAK, DOUBLE_TEAM, FACADE, ICE_PUNCH, REST, ATTRACT, FOCUS_BLAST, ENDURE, WATER_PULSE, PAYBACK, RETALIATE, GIGA_IMPACT, DUAL_CHOP, LASER_FOCUS, SWAGGER, SLEEP_TALK, SUBSTITUTE, ROCK_SMASH, WATERFALL, SURF, STRENGTH, WHIRLPOOL, ROCK_CLIMB, DIVE
	; end
