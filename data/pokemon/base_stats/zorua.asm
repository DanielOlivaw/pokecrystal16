	...
	; tm/hm learnset
	tmhm HONE_CLAWS, CALM_MIND, ROAR, TOXIC, CURSE, HIDDEN_POWER, SUNNY_DAY, PROTECT, RAIN_DANCE, MIRROR_MOVE, RETURN, DIG, SHADOW_BALL, DOUBLE_TEAM, SLUDGE_BOMB, AERIAL_ACE, FACADE, REST, ATTRACT, THIEF, FOUL_PLAY, ENDURE, PAYBACK, RETALIATE, SWORDS_DANCE, PSYCH_UP, GRASS_KNOT, SWAGGER, SLEEP_TALK, U_TURN, SUBSTITUTE, OMINOUS_WIND, UPROAR, DARK_PULSE, CUT
	; end
