	...
	; tm/hm learnset
	tmhm HONE_CLAWS, HEADBUTT, ROAR, TOXIC, CURSE, HIDDEN_POWER, PROTECT, SAFEGUARD, IRON_TAIL, EARTHQUAKE, RETURN, BRICK_BREAK, DOUBLE_TEAM, SANDSTORM, ROCK_TOMB, AERIAL_ACE, FACADE, REST, ATTRACT, ECHOED_VOICE, FOCUS_BLAST, FALSE_SWIPE, ENDURE, DRAGON_PULSE, SHADOW_CLAW, PAYBACK, DUAL_CHOP, SWORDS_DANCE, ROCK_SLIDE, X_SCISSOR, SWAGGER, SLEEP_TALK, SUBSTITUTE, ROCK_SMASH, UPROAR, CUT, DRACO_METEOR
	; end
