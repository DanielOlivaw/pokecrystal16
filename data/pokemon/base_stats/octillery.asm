	...
	; tm/hm learnset
	tmhm TOXIC, CURSE, HIDDEN_POWER, SUNNY_DAY, MUD_SHOT, ICE_BEAM, BLIZZARD, HYPER_BEAM, PROTECT, RAIN_DANCE, RETURN, PSYCHIC_M, DOUBLE_TEAM, SIGNAL_BEAM, FLAMETHROWER, SLUDGE_BOMB, FIRE_BLAST, FACADE, REST, ATTRACT, THIEF, ENERGY_BALL, SCALD, CHARGE_BEAM, ENDURE, WATER_PULSE, BULLET_SEED, PAYBACK, GIGA_IMPACT, ICY_WIND, THUNDER_WAVE, SWAGGER, SLEEP_TALK, SUBSTITUTE, FLASH_CANNON, WATERFALL, SURF, WHIRLPOOL, DIVE
	; end
