	...
	; tm/hm learnset
	tmhm TOXIC, CURSE, VENOSHOCK, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, THUNDERBOLT, THUNDER, RETURN, SHADOW_BALL, DOUBLE_TEAM, FLAMETHROWER, SLUDGE_BOMB, FIRE_BLAST, FACADE, REST, ATTRACT, THIEF, PLAY_ROUGH, ENDURE, WILL_O_WISP, EXPLOSION, PAYBACK, GIGA_IMPACT, FLASH, GYRO_BALL, DEFOG, INFESTATION, SWAGGER, SLEEP_TALK, SUBSTITUTE, OMINOUS_WIND, UPROAR, DARK_PULSE, DAZZLING_GLEAM
	; end
