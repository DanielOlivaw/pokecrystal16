	...
	; tm/hm learnset
	tmhm PSYSHOCK, CALM_MIND, TOXIC, HAIL, CURSE, HIDDEN_POWER, ICE_BEAM, BLIZZARD, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, SAFEGUARD, ZEN_HEADBUTT, EARTHQUAKE, RETURN, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, REFLECT, SIGNAL_BEAM, SANDSTORM, ROCK_TOMB, FACADE, REST, WEATHER_BALL, CHARGE_BEAM, ENDURE, ACROBATICS, EXPLOSION, GIGA_IMPACT, ROCK_POLISH, FLASH, ICY_WIND, GYRO_BALL, STEALTH_ROCK, PSYCH_UP, EARTH_POWER, LASER_FOCUS, ROCK_SLIDE, DREAM_EATER, GRASS_KNOT, SWAGGER, SLEEP_TALK, SUBSTITUTE, TRICK_ROOM
	; end
