	...
	; tm/hm learnset
	tmhm TOXIC, HAIL, CURSE, HIDDEN_POWER, MUD_SHOT, ICE_BEAM, BLIZZARD, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, SAFEGUARD, IRON_TAIL, RETURN, DOUBLE_TEAM, FACADE, REST, ATTRACT, WEATHER_BALL, SCALD, ENDURE, DRAGON_PULSE, WATER_PULSE, GIGA_IMPACT, ICY_WIND, PSYCH_UP, LASER_FOCUS, SWAGGER, SLEEP_TALK, SUBSTITUTE, WATERFALL, SURF, WHIRLPOOL, DIVE
	; end
