	...
	; tm/hm learnset
	tmhm HONE_CLAWS, HEADBUTT, ROAR, TOXIC, CURSE, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, MIRROR_MOVE, SOLARBEAM, EARTHQUAKE, RETURN, DIG, BRICK_BREAK, DOUBLE_TEAM, FLAMETHROWER, FIRE_BLAST, ROCK_TOMB, AERIAL_ACE, THUNDERPUNCH, FACADE, REST, ATTRACT, FIRE_PUNCH, ECHOED_VOICE, FOCUS_BLAST, ENDURE, WILL_O_WISP, ACROBATICS, SHADOW_CLAW, GIGA_IMPACT, DUAL_CHOP, SWORDS_DANCE, LASER_FOCUS, ROCK_SLIDE, DEFOG, POISON_JAB, SWAGGER, SLEEP_TALK, U_TURN, SUBSTITUTE, ROCK_SMASH, CUT, STRENGTH, ROCK_CLIMB, BLAST_BURN
	; end
