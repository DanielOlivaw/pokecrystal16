	...
	; tm/hm learnset
	tmhm PSYSHOCK, CALM_MIND, ROAR, TOXIC, CURSE, HIDDEN_POWER, HYPER_BEAM, LIGHT_SCREEN, PROTECT, MIRROR_MOVE, RETURN, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, REFLECT, SIGNAL_BEAM, AERIAL_ACE, FACADE, REST, STEEL_WING, ENDURE, GIGA_IMPACT, FLASH, PSYCH_UP, LASER_FOCUS, DEFOG, SWAGGER, SLEEP_TALK, U_TURN, SUBSTITUTE, TRICK_ROOM, ROCK_SMASH, OMINOUS_WIND, FLY
	; end
