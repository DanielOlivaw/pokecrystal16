	...
	; tm/hm learnset
	tmhm TOXIC, CURSE, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, MIRROR_MOVE, SAFEGUARD, SOLARBEAM, RETURN, SHADOW_BALL, DOUBLE_TEAM, FACADE, REST, ATTRACT, STEEL_WING, ECHOED_VOICE, ENERGY_BALL, FALSE_SWIPE, ENDURE, ACROBATICS, SHADOW_CLAW, GIGA_IMPACT, FLASH, SWORDS_DANCE, LASER_FOCUS, DEFOG, GRASS_KNOT, SWAGGER, SLEEP_TALK, U_TURN, SUBSTITUTE, ROCK_SMASH, OMINOUS_WIND, CUT, FRENZY_PLANT
	; end
