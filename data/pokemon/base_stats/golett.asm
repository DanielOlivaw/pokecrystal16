	...
	; tm/hm learnset
	tmhm HEADBUTT, TOXIC, CURSE, HIDDEN_POWER, ICE_BEAM, PROTECT, RAIN_DANCE, SAFEGUARD, EARTHQUAKE, RETURN, DIG, PSYCHIC_M, SHADOW_BALL, BRICK_BREAK, DOUBLE_TEAM, SIGNAL_BEAM, ROCK_TOMB, THUNDERPUNCH, FACADE, ICE_PUNCH, REST, THIEF, FIRE_PUNCH, FOCUS_BLAST, ENDURE, ROCK_POLISH, FLASH, ICY_WIND, GYRO_BALL, STEALTH_ROCK, EARTH_POWER, ROCK_SLIDE, GRASS_KNOT, SWAGGER, SLEEP_TALK, SUBSTITUTE, ROCK_SMASH, OMINOUS_WIND, STRENGTH, ROCK_CLIMB
	; end
