	...
	; tm/hm learnset
	tmhm HONE_CLAWS, HEADBUTT, CALM_MIND, ROAR, TOXIC, CURSE, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, SOLARBEAM, IRON_TAIL, EARTHQUAKE, RETURN, DIG, BRICK_BREAK, DOUBLE_TEAM, FLAMETHROWER, FIRE_BLAST, ROCK_TOMB, AERIAL_ACE, THUNDERPUNCH, FACADE, REST, ATTRACT, FIRE_PUNCH, PLAY_ROUGH, FOCUS_BLAST, ENDURE, WILL_O_WISP, ACROBATICS, SHADOW_CLAW, RETALIATE, GIGA_IMPACT, DUAL_CHOP, SWORDS_DANCE, STEALTH_ROCK, LASER_FOCUS, ROCK_SLIDE, POISON_JAB, GRASS_KNOT, SWAGGER, SLEEP_TALK, U_TURN, SUBSTITUTE, ROCK_SMASH, UPROAR, CUT, STRENGTH, ROCK_CLIMB, BLAST_BURN
	; end
