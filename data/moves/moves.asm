...
Moves1:
	...
	move EFFECT_REMOVE_ITEM_HIT,    65, DARK,     PHYSICAL, 100, 20, 100 ; KNOCK_OFF
	...
	move EFFECT_REMOVE_ITEM_HIT,    60, FIRE,     SPECIAL,  100, 15, 100 ; INCINERATE
	...
	move EFFECT_CURE_PARALYSIS_HIT, 10, NORMAL,   PHYSICAL, 100, 10,   0 ; SMELLINGSALT
	...
	move EFFECT_MIRROR_MOVE,         0, NORMAL,   STATUS,     1, 20,   0 ; ME_FIRST
	...
	move EFFECT_DYNAMO_RUSH,        65, FAIRY,    PHYSICAL, 100, 15, 100 ; GUILE_FANG
	move EFFECT_DYNAMO_RUSH,        60, NORMAL,   SPECIAL,  100, 10, 100 ; DATA_PULSE
