...
Moves1:
	...
	move EFFECT_STATUS_SELF,         0, ICE,      STATUS,   100, 30,   0 ; MIST
	...
	move EFFECT_STATUS_SELF,         0, PSYCHIC,  STATUS,   100, 30,   0 ; LIGHT_SCREEN
	move EFFECT_RESET_STATS,         0, ICE,      STATUS,   100, 30,   0 ; HAZE
	move EFFECT_STATUS_SELF,         0, PSYCHIC,  STATUS,   100, 20,   0 ; REFLECT
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 30,   0 ; FOCUS_ENERGY
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 10,   0 ; SUBSTITUTE
	...
	move EFFECT_STATUS_SELF,         0, BUG,      STATUS,   100, 10,   0 ; SPIDER_WEB
	...
	move EFFECT_STATUS_SELF,         0, GHOST,    STATUS,   100, 10,   0 ; CURSE
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 10,   0 ; BELLY_DRUM
	...
	move EFFECT_STATUS_SELF,         0, GROUND,   STATUS,   100, 20,   0 ; SPIKES
	...
	move EFFECT_STATUS_SELF,         0, GHOST,    STATUS,   100,  5,   0 ; DESTINY_BOND
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100,  5,   0 ; PERISH_SONG
	...
	move EFFECT_STATUS_SELF,         0, ROCK,     STATUS,   100, 10,   0 ; SANDSTORM
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100,  5,   0 ; MEAN_LOOK
	move EFFECT_STATUS_OPP,          0, NORMAL,   STATUS,   100, 15,   0 ; ATTRACT
	move EFFECT_SLEEP_TALK,          0, NORMAL,   STATUS,   100, 10,   0 ; SLEEP_TALK
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100,  5,   0 ; HEAL_BELL
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 25,   0 ; SAFEGUARD
	...
	move EFFECT_STATUS_SELF,         0, WATER,    STATUS,   100,  5,   0 ; RAIN_DANCE
	move EFFECT_STATUS_SELF,         0, FIRE,     STATUS,   100,  5,   0 ; SUNNY_DAY
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 10,   0 ; PSYCH_UP
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 15,   0 ; SHELL_SMASH
	...
	move EFFECT_STATUS_SELF,         0, BUG,      STATUS,   100, 20,   0 ; QUIVER_DANCE
	...
	move EFFECT_STATUS_SELF,         0, ICE,      STATUS,   100, 10,   0 ; HAIL
	...
	move EFFECT_STATUS_SELF,         0, ICE,      STATUS,   100, 20,   0 ; AURORA_VEIL
	...
	move EFFECT_STATUS_SELF,         0, GRASS,    STATUS,   100,  5,   0 ; AROMATHERAPY
	...
	move EFFECT_STATUS_SELF,         0, POISON,   STATUS,   100, 20,   0 ; TOXIC_SPIKES
	move EFFECT_STATUS_SELF,         0, ROCK,     STATUS,   100, 20,   0 ; STEALTH_ROCK
	move EFFECT_STATUS_SELF,         0, BUG,      STATUS,   100, 10,   0 ; STICKY_WEB
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 15,   0 ; REFLECT_TYPE
	...
	move EFFECT_STATUS_SELF,         0, FAIRY,    STATUS,   100, 10,   0 ; MISTY_TERRAIN
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 20,   0 ; STOCKPILE
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100,  5,   0 ; BLOCK
	...
	move EFFECT_STATUS_SELF,         0, GRASS,    STATUS,   100, 20, 100 ; BRIGHT_MOSS
	...
	move EFFECT_STATUS_SELF,         0, GRASS,    STATUS,   100, 20,   0 ; INGRAIN
	...
	move EFFECT_STATUS_SELF,         0, POISON,   STATUS,   100, 20,   0 ; COIL
	...
	move EFFECT_DEFENSE_UP_3,        0, GRASS,    STATUS,   100, 10,   0 ; COTTON_GUARD
	...
	move EFFECT_TEARFUL_LOOK,        0, NORMAL,   STATUS,   100, 20,   0 ; TEARFUL_LOOK
	...
	move EFFECT_ACUPRESSURE,         0, NORMAL,   STATUS,   100, 30,   0 ; ACUPRESSURE
	...
	move EFFECT_STATUS_SELF,         0, ELECTRIC, STATUS,   100, 20,   0 ; CHARGE
	move EFFECT_BELCH,             120, POISON,   SPECIAL,   90, 10,   0 ; BELCH
	move EFFECT_YAWN,                0, NORMAL,   STATUS,   100, 10,   0 ; YAWN
	...
	move EFFECT_ATK_SP_ATK_DOWN,     0, NORMAL,   STATUS,   100, 30,   0 ; NOBLE_ROAR
	...
	move EFFECT_SPIKY_SHIELD,        0, GRASS,    STATUS,   100, 10,   0 ; SPIKY_SHIELD
	move EFFECT_KINGS_SHIELD,        0, STEEL,    STATUS,   100, 10,   0 ; KINGS_SHIELD
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 30,   0 ; LUCKY_CHANT
	move EFFECT_STATUS_SELF,         0, WATER,    STATUS,   100, 20,   0 ; AQUA_RING
	move EFFECT_STATUS_SELF,         0, GHOST,    STATUS,   100,  5,   0 ; GRUDGE
	...
	move EFFECT_COSMIC_POWER,        0, BUG,      STATUS,   100, 10,   0 ; DEFEND_ORDER
	...
	move EFFECT_CONFIDE,             0, NORMAL,   STATUS,   100, 20,   0 ; CONFIDE
	...
	move EFFECT_MIRROR_MOVE,         0, NORMAL,   STATUS,   100, 20,   0 ; ME_FIRST
	move EFFECT_BODY_PRESS,         80, FIGHTING, PHYSICAL, 100, 10,   0 ; BODY_PRESS
	move EFFECT_MEMENTO,             0, DARK,     STATUS,   100, 10,   0 ; MEMENTO
	move EFFECT_HEALING_WISH,        0, PSYCHIC,  STATUS,   100, 10,   0 ; HEALING_WISH
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 10,   0 ; SWALLOW
	...
	move EFFECT_STATUS_SELF,         0, GRASS,    STATUS,   100,  5,   0 ; CULTIVATE
	...
	move EFFECT_STATUS_OPP_ACC,      0, PSYCHIC,  STATUS,   100, 10,   0 ; POWER_SPLIT
	move EFFECT_STATUS_OPP_ACC,      0, PSYCHIC,  STATUS,   100, 10,   0 ; GUARD_SPLIT
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 30,   0 ; LASER_FOCUS
	...
	move EFFECT_STATUS_SELF,         0, NORMAL,   STATUS,   100, 10,   0 ; WISH
	...
	move EFFECT_STATUS_OPP_ACC,      0, DARK,     STATUS,   100, 20,   0 ; TOPSY_TURVY
	move EFFECT_LEECH_HIT,          65, ELECTRIC, SPECIAL,  100, 20,   0 ; PARABOLIC_CHARGE
	move EFFECT_STATUS_OPP_ACC,      0, ELECTRIC, STATUS,   100, 20,   0 ; ELECTRIFY
	move EFFECT_STATUS_SELF,         0, FAIRY,    STATUS,   100,  5,   0 ; FAIRY_LOCK
	move EFFECT_NORMAL_HIT,         40, GRASS,    PHYSICAL, 100, 40,   0 ; BRANCH_POKE
	move EFFECT_GEOMANCY,            0, FAIRY,    STATUS,   100, 10,   0 ; GEOMANCY
	...
	move EFFECT_SHORE_UP,            0, GROUND,   STATUS,   100, 10,   0 ; SHORE_UP
	...
	move EFFECT_STATUS_SELF,         0, DRAGON,   STATUS,   100,  5,   0 ; CLANGOROUS_SOUL
	...
	move EFFECT_SP_ATK_UP_3,         0, BUG,      STATUS,   100, 20,   0 ; TAIL_GLOW
