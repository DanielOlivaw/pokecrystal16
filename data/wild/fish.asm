...
TimeFishGroups:
	;     day             nite
	dbwbw 20, CORSOLA_G,  20, STARYU     ; 0
	dbwbw 40, CORSOLA_G,  40, STARYU     ; 1
	...
	dbwbw 20, CORPHISH,    20, CORPHISH    ; 6
	dbwbw 40, CORPHISH,    40, CORPHISH    ; 7
	dbwbw 20, DRATINI,    20, DRATINI    ; 8
	dbwbw 40, DRATINI,    40, DRATINI    ; 9
	dbwbw 20, RELICANTH,   20, RELICANTH   ; 10
	dbwbw 40, RELICANTH,   40, RELICANTH   ; 11
