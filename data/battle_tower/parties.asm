...
BattleTowerMons10:
	...
	dw LUXRAY
	db BRIGHTPOWDER
	dw THUNDER_WAVE, THUNDERBOLT, CRUNCH, U_TURN
	...
	dw HAXORUS
	db MIRACLEBERRY
	dw DUAL_CHOP, EARTHQUAKE, HYPER_BEAM, ROCK_SLIDE
	...
	dw STEELIX
	db LEFTOVERS
	dw EARTHQUAKE, GIGA_IMPACT, SWAGGER, CRUNCH
	...
	dw ALTARIA
	db KINGS_ROCK
	dw DRACO_METEOR, STEEL_WING, HYPER_BEAM, PERISH_SONG
	...
	dw SNEASEL
	db SCOPE_LENS
	dw SLASH, SHATTER_CLAW, POISON_JAB, FAINT_ATTACK
	...
	dw SCIZOR
	db QUICK_CLAW
	dw BULLET_PUNCH, U_TURN, SLASH, TOXIC
	...
	dw PILOSWINE
	db MINT_BERRY
	dw REST, BLIZZARD, GIGA_IMPACT, EARTHQUAKE
	...
	dw EXEGGUTOR_A
	db QUICK_CLAW
	dw DRAGONHAMMER, TOXIC, EXPLOSION, GIGA_DRAIN
	...
	dw BLAZIKEN
	db FOCUS_BAND
	dw COUNTER, FIRE_PUNCH, THUNDERPUNCH, BRICK_BREAK
