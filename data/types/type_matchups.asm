TypeMatchups:
	...
	db FIGHTING,  FAIRY,     NOT_VERY_EFFECTIVE ; new
	...
	db POISON,    FAIRY,     SUPER_EFFECTIVE ; new
	...
	db BUG,       FAIRY,     NOT_VERY_EFFECTIVE ; new
	...
	db STEEL,     FAIRY,     SUPER_EFFECTIVE ; new
	db FAIRY,     FIRE,      NOT_VERY_EFFECTIVE ; new
	db FAIRY,     FIGHTING,  SUPER_EFFECTIVE ; new
	db FAIRY,     POISON,    NOT_VERY_EFFECTIVE ; new
