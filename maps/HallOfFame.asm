...
.EnterHallOfFameScript:
	...
	clearevent EVENT_CHUCK_REMATCH
	clearevent EVENT_PRYCE_REMATCH
	clearevent EVENT_CLAIR_REMATCH
	clearevent EVENT_BEAT_KIMONO_GIRL_NAOKO_REMATCH
	clearevent EVENT_BEAT_KIMONO_GIRL_SAYO_REMATCH
	clearevent EVENT_BEAT_KIMONO_GIRL_ZUKI_REMATCH
	clearevent EVENT_BEAT_KIMONO_GIRL_KUNI_REMATCH
	clearevent EVENT_BEAT_KIMONO_GIRL_MIKI_REMATCH
	clearevent EVENT_GOT_PROTECTOR
