...
Route40_MapEvents:
	...
	object_event  5, 20, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 4, TrainerSwimmerfElaine, -1
	...
	tmhmball_event 16, 25, TM_WATER_PULSE, EVENT_ROUTE_40_TM_WATER_PULSE
