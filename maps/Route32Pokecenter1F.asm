	...
	const ROUTE32POKECENTER1F_LASS
...
Route32Pokecenter1F_MapEvents:
	...
	object_event  5,  5, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Susan, -1
