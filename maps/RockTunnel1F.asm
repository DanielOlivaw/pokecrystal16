...
RockTunnel1F_MapEvents:
	...
	warp_event  3, 11, ROCK_TUNNEL_2F, 1
	...
	object_event 10, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RockTunnel1FOvalStone, EVENT_ROCK_TUNNEL_1F_TM_STEEL_WING
