...
.Script:
	...
	iftrue .AskAgain
	writetext PokefanfBeverly1AfterBattleText
	buttonsound
...
PokefanfBeverly1AfterBattleText:
...
NationalPark_MapEvents:
	...
	object_event 26, 40, SPRITE_LIEPARD, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, NationalParkPersian, -1
	...
	tmhmball_event  1, 43, TM_DIG, EVENT_NATIONAL_PARK_TM_DIG
