...
Route2HiddenMaxRevive:
	hiddenitem MAX_REVIVE, EVENT_ROUTE_2_HIDDEN_REVIVE
...
Route2_MapEvents:
	...
	warp_event  3, 31, VIRIDIAN_FOREST_GATE_SOUTH, 3
	warp_event  2,  9, VIRIDIAN_FOREST_GATE_NORTH, 1
	warp_event  3,  9, VIRIDIAN_FOREST_GATE_NORTH, 2
	...
	bg_event 17, 43, BGEVENT_ITEM, Route2HiddenFullHeal
	bg_event  8, 10, BGEVENT_ITEM, Route2HiddenMaxRevive
	...
	object_event 14, 49, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2Elixer, EVENT_ROUTE_2_ELIXER
