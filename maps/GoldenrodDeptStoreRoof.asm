...
GoldenrodDeptStoreRoof_MapEvents:
	...
	object_event 10,  3, SPRITE_POKEFAN_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreRoofPokefanFScript, EVENT_GOLDENROD_CITY_CIVILIANS
