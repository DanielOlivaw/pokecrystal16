	...
	const LAVENDERMART_CLERK1
	const LAVENDERMART_CLERK2
...
LavenderMartClerk1Script:
	jumpstd standardmart

LavenderMartClerk2Script:
	opentext
...
LavenderMart_MapEvents:
	...
	db 4 ; object events
	object_event  1,  3, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LavenderMartClerk1Script, -1
	object_event  1,  2, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LavenderMartClerk2Script, -1
